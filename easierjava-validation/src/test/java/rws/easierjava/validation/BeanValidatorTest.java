...
public class BeanValidatorTest {
	...
	public void testIsValid() {
		...
		Assert.assertThat(violations.get("name").getMessageTemplate(), Is.is("{javax.validation.constraints.NotNull.message}"));
		...
		Assert.assertThat(violations.get("friend.name").getMessageTemplate(), Is.is("{javax.validation.constraints.NotNull.message}"));
		...
		Assert.assertThat(violations.get("nextFavNum").getMessageTemplate(), Is.is("{javax.validation.constraints.Min.message}"));
		...
		Assert.assertThat(violations.get("friend.nextFavNum").getMessageTemplate(), Is.is("Must be a number less than {value}"));
		...
		Assert.assertThat(violations.get("moreNums").getInvalidValue(), Is.is(Arrays.asList(1,2,3,4,5,6,7,8,9)));
