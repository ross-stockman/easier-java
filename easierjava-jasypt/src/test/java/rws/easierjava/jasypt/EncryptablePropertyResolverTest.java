...
public class EncryptablePropertyResolverTest {
	...
	public void testEncryptedProperty() {
		...
		systemUnderTest.registerClassPathProperties("application.properties");
		Assert.assertThat(systemUnderTest.getProperty("secret"), Is.is("pie"));
	}
	...
	public void testUnecryptedProperty() {
		...
		systemUnderTest.registerClassPathProperties("application.properties");
		Assert.assertThat(systemUnderTest.getProperty("not.secret"), Is.is("LnoNtGiL51PqEQKsR8ZnEA==)"));
		Assert.assertThat(systemUnderTest.getProperty("also.not.secret"), Is.is("ENC(LnoNtGiL51PqEQKsR8ZnEA=="));
	}
	...
	public void testDefaultValue() {
		...
		systemUnderTest.registerClassPathProperties("application.properties");
		Assert.assertThat(systemUnderTest.getProperty("secrets"), IsNull.nullValue());
		Assert.assertThat(systemUnderTest.getProperty("secrets", "default"), Is.is("default"));
	}
}
